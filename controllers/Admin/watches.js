...
module.exports.create = async function (req, res, next)
{
    try
    {
        ...
        watch.section5Titles = Request.validateName(req.body.payload.section5Titles, 'section5Title', {optional: true});
        watch.section5Paragraphs = Request.validateName(req.body.payload.section5Paragraphs, 'section5Paragraph', {optional: true});
